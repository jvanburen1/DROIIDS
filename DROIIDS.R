...
#'
#' @description This function uses a Bayesian hierarchical model to collectively analyze a set of data
#'    containing correlated observations collected across time on independent subjects. The data and process models are:
#'
...
#'    }
#'
#' @return A list containing information from the DROIIDS analysis is produced from this function.  Information in this list is used to create summary statistics,
#'    calculate estimates and rates of changes, and plot the data.
#' @export
